...
public class DeclaracionSiniestro 
{
    private
    String codigo;
    ...
    public DeclaracionSiniestro( String codigo, Date fechaocurrencia, Date fechareigstro,
    ...
    String nombrecli, String placacli,String marcacli, String modelocli, 
    ...
    String apellidocli,String status) 
    {
        this.codigo = codigo;
