...
public class VentanaConsultarVehiculo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblCliTitulo.setText("Listado de Vehiculos");
        getContentPane().add(lblCliTitulo);
        lblCliTitulo.setBounds(399, 55, 184, 22);

        jTableVehiculos.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jTableVehiculos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Placa", "Marca", "Modelo", "Año", "Color", "Código de Póliza", "Tipo de vehículo", "Precio", "Cédula del cliente", "Nombre del cliente"
            }
        ) {
        ...
        jScrollPane1.setBounds(10, 106, 1051, 465);
